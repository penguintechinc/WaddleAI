...
| `orchestration` | `gemma4:12b-it-qat` | ChatAgent orchestration, routing decisions. Coding role. |
...
| `exploration` | `gemma4:12b-it-qat` | Standard codebase exploration, file reading. Coding role. |
| `exploration_lite` | `gemma4:12b-it-qat` | Quick file reads -- still a coding role, so it follows the coding default rather than the `e4b` floor. |

**`gemma4:12b-it-qat` is the default for every CODING role** (orchestration, exploration, explorer, foreman) -- `gemma4:e4b` tested poorly at coding on 2026-09-08. `gemma4:e4b` remains the default for routing and general/non-code roles (research, tester), where it performs fine. `12b` needs ~8GB VRAM.
...
| `explorer` | Codebase navigation | `gemma4:12b-it-qat` (coding role) |
...
| `PENGUINCODE_MODEL_ORCHESTRATION` | `gemma4:12b-it-qat` | `models.orchestration` | Orchestration model. |
...
| `PENGUINCODE_MODEL_EXPLORATION` | `gemma4:12b-it-qat` | `models.exploration` | Exploration model. |
| `PENGUINCODE_MODEL_EXPLORATION_LITE` | `gemma4:12b-it-qat` | `models.exploration_lite` | Lite exploration model. |
...
| `PENGUINCODE_AGENT_EXPLORER` | `gemma4:12b-it-qat` | `agents.explorer.model` | Explorer agent model. |
...
| `PENGUINCODE_AGENT_RESEARCHER` | `gemma4:e4b` | `agents.researcher.model` | Researcher agent model. |
